...
public class Main {
    ...
    public static void checkAndStep(int[][] arr, int quantity) {  // сначала ищем, куда поставить 0
        ...
        if (quantity >= 2) {
            ...
            for (int i = 0; i < arr.length; i++) {
                if (arr[i][0] == 1 && arr[i][1] == 1 && arr[i][2] == 2) {
                    stepComp(arr, i, 2);
                    return;
                }
                if (arr[i][0] == 1 && arr[i][1] == 2 && arr[i][2] == 1) {
                    stepComp(arr, i, 1);
                    return;
                }
                if (arr[i][0] == 2 && arr[i][1] == 1 && arr[i][2] == 1) {
                    stepComp(arr, i, 0);
                    return;
                }
            }
            ...
            for (int i = 0; i < arr.length; i++) {
                if (arr[0][i] == 1 && arr[1][i] == 1 && arr[2][i] == 2) {
                    stepComp(arr, 2, i);
                    return;
                }
                if (arr[0][i] == 1 && arr[1][i] == 2 && arr[2][i] == 1) {
                    stepComp(arr, 1, i);
                    return;
                }
                if (arr[0][i] == 2 && arr[1][i] == 1 && arr[2][i] == 1) {
                    stepComp(arr, 0, i);
                    return;
                }
            }
            //проверка  1 диагонали
            if (arr[0][0] == 1 && arr[1][1] == 1 && arr[2][2] == 2) {
                stepComp(arr, 2, 2);
                return;
            }
            if (arr[0][0] == 1 && arr[1][1] == 2 && arr[2][2] == 1) {
                stepComp(arr, 1, 1);
                return;
            }
            if (arr[0][0] == 2 && arr[1][1] == 1 && arr[2][2] == 1) {
                stepComp(arr, 0, 0);
                return;
            }
            //проверка  2 горизонтали
            if (arr[2][0] == 1 && arr[1][1] == 1 && arr[0][2] == 2) {
                stepComp(arr, 0, 2);
                return;
            }
            if (arr[2][0] == 1 && arr[1][1] == 2 && arr[0][2] == 1) {
                stepComp(arr, 1, 1);
                return;
            }
            if (arr[2][0] == 2 && arr[1][1] == 1 && arr[0][2] == 1) {
                stepComp(arr, 2, 0);
                return;
            }


            // если не находим, тогда ищем единицу и ставим возле нее
            for (int i = 0; i < arr.length; i++) {
                for (int j = 0; j < arr[i].length; j++) {
                    if (arr[i][j] == 2) {
                        stepComp(arr, i, j);
    ...
    static boolean checkZero(int[][] arr) { // ищем, есть ли на поле последовательность 0, чтобы поставить тертий ноль и выиграть
        //проверка горизонтали
        for (int i = 0; i < arr.length; i++) {
            if (arr[i][0] == 0 && arr[i][1] == 0 && arr[i][2] == 2) {
                stepComp(arr, i, 2);
                return true;
            }
            if (arr[i][0] == 0 && arr[i][1] == 2 && arr[i][2] == 0) {
                stepComp(arr, i, 1);
                return true;
            }
            if (arr[i][0] == 2 && arr[i][1] == 0 && arr[i][2] == 0) {
                stepComp(arr, i, 0);
                return true;
            }
        }
        //проверка 1 диагонали
        for (int i = 0; i < arr.length; i++) {
            if (arr[0][i] == 0 && arr[1][i] == 0 && arr[2][i] == 2) {
                stepComp(arr, 2, i);
                return true;
            }
            if (arr[0][i] == 0 && arr[1][i] == 2 && arr[2][i] == 0) {
                stepComp(arr, 1, i);
                return true;
            }
            if (arr[0][i] == 2 && arr[1][i] == 0 && arr[2][i] == 0) {
                stepComp(arr, 0, i);
                return true;
            }
        }
        //проверка  1 диагонали
        if (arr[0][0] == 0 && arr[1][1] == 0 && arr[2][2] == 2) {
            stepComp(arr, 2, 2);
            return true;
        }
        if (arr[0][0] == 0 && arr[1][1] == 2 && arr[2][2] == 0) {
            stepComp(arr, 1, 1);
            return true;
        }
        if (arr[0][0] == 2 && arr[1][1] == 0 && arr[2][2] == 0) {
            stepComp(arr, 0, 0);
            return true;
        }
        //проверка  2 горизонтали
        if (arr[2][0] == 0 && arr[1][1] == 0 && arr[0][2] == 2) {
            stepComp(arr, 0, 2);
            return true;
        }
        if (arr[2][0] == 0 && arr[1][1] == 2 && arr[0][2] == 0) {
            stepComp(arr, 1, 1);
            return true;
        }
        if (arr[2][0] == 2 && arr[1][1] == 0 && arr[0][2] == 0) {
            stepComp(arr, 2, 0);
        }
    ...
    static boolean hasWinFailed(int[][] arr) { //проверка выиграл/проиграл или клетки закончились
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            if (arr[2][2] == 1 && arr[1][1] == 1 && arr[0][0] == 1) {
                System.out.println("Win");
                return true;
            }
